...
type LiftPicker interface {
	PickLift() Lift // will return a Lift (is of int type - type alias)
}
...
// Vehicles have model name in addition to the vehicle type
...
// Write a single function to handle all the vehicles that the shop works on
